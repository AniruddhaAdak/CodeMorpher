...
import { Mic, Upload, Copy, Download, Wand2, Code2, ArrowRight } from 'lucide-react'
...
export default function VoiceVista() {
  ...
  // New functions for code conversion
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 to-indigo-200 flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-8">
          <h2 className="text-2xl font-bold mb-4 text-indigo-700">Code Conversion</h2>
          {error && (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="text-xl font-semibold">Converted Code</h3>
                <LanguageSelector
                  value={targetLang}
